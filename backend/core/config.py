...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: List[str] = [
        ...
        for origin in os.getenv(
            "CORS_ORIGINS",
            "http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000,http://127.0.0.1:3000,http://localhost:8000,http://127.0.0.1:8000,https://atsrecruit.vercel.app,https://enterrecruit.vercel.app"
        ).split(",")
        if origin.strip()
    ]
